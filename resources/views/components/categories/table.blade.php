    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                ...
                <th scope="col" class="px-4 py-3">Name Category</th>
                    ...
                    <form action="/categories/{{ $category->slug }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-4">
                            ...
                            <div class="col-span-1 sm:col-span-4">
                                ...
                                <textarea placeholder="Enter a description..." type="text" rows="6" name="description"
                            ...
                            <div class="col-span-1 sm:col-span-1">
                                <div class="flex items-center justify-center m-3">
                                    <img src="{{ $category->cover ? asset('storage/' . $category->cover) :
                                    asset('assets/images/user/user-default.png') }}" alt="{{ $category->name }}"
                                        class="h-[56px] w-auto rounded-full" id="cover-preview-update">
                                </div>
                            </div>
                            ...
                            <div class="col-span-1 sm:col-span-3">
                                ...
                                <input
                                    ...
                                    aria-describedby="user_avatar_help" data-preview-target="cover-preview-update"
