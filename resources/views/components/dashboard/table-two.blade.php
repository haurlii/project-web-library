    ...
    <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">
                Transaksi Pengembalian Terbaru
            </h3>
        </div>

        <div class="flex items-center gap-3">
            <a href="/dashboard/return-books"
                        ...
                        <div class="flex items-center">
                            <div class="flex items-center gap-3">
                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                    <img src="{{ $return->user->avatar ? asset('storage/' . $return->user->avatar) :
                                    asset('assets/images/user/user-default.png') }}"
                                        alt="{{ $return->user->first . ' ' . $return->user->lastname }}" />
                                </div>
                                <div>
