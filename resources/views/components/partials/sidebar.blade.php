        ...
        <nav x-data="{selected: $persist('Dashboard')}">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    <!-- Menu Item Dashboard -->
<li>
    <a href="{{ route('admin.dashboard') }}" @click="selected = (selected === 'Dashboard' ? '':'Dashboard')"
...
<li>
    <a href="{{ route('admin.authors.index') }}" @click="selected = (selected === 'Penulis Buku' ? '':'Penulis Buku')"
        class="menu-item group" :class="(page === 'Penulis Buku') ? 'menu-item-active' : 'menu-item-inactive'">
        <svg :class="(page === 'Penulis Buku') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24"
...
<li>
    <a href="{{ route('admin.publishers.index') }}"
        ...
        <svg :class="(page === 'Penerbit Buku') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24"
...
<li>
    <a href="{{ route('admin.categories.index') }}"
        ...
        <svg :class="(page === 'Kategori Buku') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24"
            height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
            <path fill-rule="evenodd" clip-rule="evenodd"
...
<li>
    <a href="{{ route('admin.books.index') }}" @click="selected = (selected === 'Buku' ? '':'Buku')"
        ...
        <svg :class="(page === 'Buku') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24" height="24"
            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
            <path fill-rule="evenodd" clip-rule="evenodd"
...
<!-- Menu Item Stok Buku -->
<li>
    <a href="{{ route('admin.stock-books.index') }}" @click="selected = (selected === 'Stok Buku' ? '':'Stok Buku')"
        class="menu-item group hover:menu-item-active hover:menu-item-icon-active"
        :class="(page === 'Stok Buku') ? 'menu-item-active' : 'menu-item-inactive'">
        <svg :class="(page === 'Stok Buku') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24"
...
<li>
    <a href="{{ route('admin.loan-books.index') }}"
        ...
        <svg :class="(page === 'Peminjaman Buku') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24"
            height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
            <path fill-rule="evenodd" clip-rule="evenodd"
...
<li>
    <a href="{{ route('admin.return-books.index') }}"
        ...
        <svg :class="(page === 'Pengembalian Buku') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24"
            height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
            <path fill-rule="evenodd" clip-rule="evenodd"
                d="M1.56641 4C1.56641 3.58579 1.90219 3.25 2.31641 3.25H3.49696C4.61854 3.25 5.56885 4.07602 5.72504 5.18668L5.7862 5.62161H19.7507C21.3714 5.62161 22.4605 7.28344 21.8137 8.76953L19.1464 14.8979C18.789 15.719 17.9788 16.25 17.0833 16.25L7.72179 16.25C6.60021 16.25 5.6499 15.424 5.49371 14.3133L4.23965 5.39556C4.18759 5.02534 3.87082 4.75 3.49696 4.75H2.31641C1.90219 4.75 1.56641 4.41421 1.56641 4ZM5.99714 7.12161L6.9791 14.1044C7.03116 14.4747 7.34793 14.75 7.72179 14.75L17.0833 14.75C17.3818 14.75 17.6519 14.573 17.771 14.2993L20.4383 8.17092C20.6539 7.67556 20.2909 7.12161 19.7507 7.12161H5.99714Z"
                fill="" />
...
<li>
    <a href="{{ route('admin.fine-settings.index') }}"
        ...
        <svg :class="(page === 'Pengaturan Denda') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24"
            height="24" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
            <path
...
<!-- Menu Item Pengguna -->
<li>
    <a href="{{ route('admin.users.index') }}" @click="selected = (selected === 'Pengguna' ? '':'Pengguna')"
        class="menu-item group hover:menu-item-active hover:menu-item-icon-active"
        :class="(page === 'Pengguna') ? 'menu-item-active' : 'menu-item-inactive'">
        <svg :class="(page === 'Pengguna') ? 'menu-item-icon-active'  : 'menu-item-icon-inactive'" width="24"
            height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
            <path fill-rule="evenodd" clip-rule="evenodd"
