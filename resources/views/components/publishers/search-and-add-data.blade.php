            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-4">
                <div class="col-span-1 sm:col-span-4">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}"
                        placeholder="Enter the author's name" autofocus autocomplete="off"
                ...
                <div class="col-span-1 sm:col-span-1">
                    <div class="flex items-center justify-center m-3">
                        <img src="{{ asset('assets/images/user/user-default.png') }}" alt="User"
                            class="h-[56px] w-auto rounded-full" id="logo-preview-create">
                    </div>
                </div>
                ...
                <div class="col-span-1 sm:col-span-3">
                    ...
                    <input
                        ...
                        aria-describedby="user_avatar_help" data-preview-target="logo-preview-create" id="logo"
