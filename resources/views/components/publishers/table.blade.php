    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                ...
                <th scope="col" class="px-4 py-3">Name Publisher</th>
        ...
        <tbody>
            ...
            <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-4 py-3 max-w-[12rem] truncate">{{ $publisher->address ?? 'Tidak Tercamtum' }}</td>
                <td class="px-4 py-3">{{ $publisher->email ?? 'Tidak Tercamtum' }}</td>
                <td class="px-4 py-3">{{ $publisher->contact ?? 'Tidak Tercamtum' }}</td>
            ...
            <div id="updatePublisherModal-{{ $publisher->id }}"
                ...
                <div class="relative w-full max-w-[584px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
                    ...
                    <form action="/publishers/{{ $publisher->slug }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-4">
                            <div class="col-span-1 sm:col-span-4">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') ?? $publisher->name }}"
                                    autofocus autocomplete="off" placeholder="Enter the publisher's name"
                            ...
                            <div class="col-span-1 sm:col-span-4">
                                ...
                                <input type="text" name="address" id="address"
                                    ...
                                    placeholder="Enter the author's address" autocomplete="off"
                            ...
                            <div class="col-span-1 sm:col-span-4">
                                ...
                                <input type="text" name="contact" id="contact"
                                    ...
                                    placeholder="Enter the author's contact" autocomplete="off"
                            ...
                            <div class="col-span-1 sm:col-span-1">
                                <div class="flex items-center justify-center m-3">
                                    <img src="{{ $publisher->logo ? asset('storage/' . $publisher->logo) :
                                    asset('assets/images/user/user-default.png') }}" alt="{{ $publisher->name }}"
                                        class="h-[56px] w-auto rounded-full" id="logo-preview-update">
                                </div>
                            </div>
                            ...
                            <div class="col-span-1 sm:col-span-3">
                                ...
                                <input
                                    ...
                                    aria-describedby="user_avatar_help" data-preview-target="logo-preview-update"
                ...
                <div class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
                    ...
                    <div class="text-center">
                        ...
                        <div class="flex items-center justify-center w-full gap-3 mt-7">
                            ...
                            <form action="/publishers/{{ $publisher->slug }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
