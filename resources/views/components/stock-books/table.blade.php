        ...
        <tbody>
            ...
            <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-8 py-3">
                    <div class="flex items-center font-medium whitespace-nowrap mr-3 max-w-2xl">
                        <img src="{{ $stock->book->cover ? asset('storage/' . $stock->book->cover) :
                                    asset('assets/images/user/user-default.png') }}" alt="{{ $stock->book->title }}"
            ...
            <div id="updateStockBookModal-{{ $stock->id }}"
                ...
                <div class="relative w-full max-w-[584px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
                    ...
                    <form action="/stock-books/{{ $stock->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <h4 class="mb-6 text-lg font-medium text-gray-800 dark:text-white/90">
                            Edit Data Stock Book
                        </h4>
