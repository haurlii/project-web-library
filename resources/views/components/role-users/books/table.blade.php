...
<div class="overflow-x-auto">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <!-- Create modal -->
            <div id="loanBookModal-{{ $book->id }}" tabindex="-1" aria-hidden="true"
                class="hidden fixed inset-0 items-center justify-center p-5 overflow-y-auto modal z-999999">
                <div data-modal-target="loanBookModal-{{ $book->id }}" tabindex="-1" aria-hidden="true"
                    data-modal-toggle="loanBookModal-{{ $book->id }}" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative w-full max-w-[584px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
                    <!-- close btn -->
                    <button data-modal-target="loanBookModal-{{ $book->id }}" tabindex="-1" aria-hidden="true"
                        data-modal-toggle="loanBookModal-{{ $book->id }}" tabindex="-1" aria-hidden="true"
                    ...
                    <form action="{{ route('user.loan-books.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-4">
                            <div class="col-span-1 sm:col-span-4">
                                ...
                                <input type="text" name="name" id="user_id"
                                    ...
                                    placeholder="Enter the user ID" autofocus autocomplete="off" readonly
                            ...
                            <div class="col-span-1 sm:col-span-4">
                                ...
                                <input type="text" name="title" id="book_id" value="{{ old('title') ?? $book->title }}"
                                    placeholder="Enter the book title" autofocus autocomplete="off" readonly
                                    class="h-11 w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs @error('title') bg-red-50 dark:bg-red-900/20 border-red-500 text-red-600 placeholder-red-50 focus:ring-red-500/10 focus:border-red-300 dark:text-red-500 dark:placeholder-red-500 dark:border-red-800 dark:focus:ring-red-50/10 dark:focus:border-red-800 @enderror border-gray-300 text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                                <input type="hidden" name="book_id" id="book_id"
                                    value="{{ old('book_id') ?? $book->id }}" />
                                @error('book_id')
                                <p class="mt-2 text-xs text-red-600 dark:text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
