...
<div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
    ...
    <div
        ...
        <button data-modal-target="createPublisherModal" data-modal-toggle="createPublisherModal" type="button"
...
<div id="createPublisherModal"
    ...
    <div data-modal-target="createPublisherModal" data-modal-toggle="createPublisherModal"
    ...
    <div class="relative w-full max-w-[960px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
        <!-- close btn -->
        <button data-modal-target="createPublisherModal" data-modal-toggle="createPublisherModal"
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-6">
                <div class="col-span-1 sm:col-span-3">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}"
                        placeholder="Masukkan nama penerbit" autofocus autocomplete="off"
                ...
                <div class="col-span-1 sm:col-span-3">
                    ...
                    <input type="text" name="contact" id="contact" value="{{ old('contact') }}"
                        placeholder="Masukkan kontak penerbit" autocomplete="off"
                ...
                <div class="col-span-1 sm:col-span-3">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}"
                        placeholder="Masukkan email penerbit" autocomplete="off"
                ...
                <div class="col-span-1 sm:col-span-6">
                    <label for="logo-create" class=" mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        Upload File
                    </label>
                    <input
                        ...
                        aria-describedby="user_avatar_help" id="logo-create" name="logo" type="file" accept="image/*">
