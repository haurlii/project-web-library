...
<div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
    ...
    <div
        ...
        <button data-modal-target="createUserModal" data-modal-toggle="createUserModal" type="button"
...
<!-- Create modal -->
<div id="createUserModal" class="hidden fixed inset-0 items-center justify-center p-5 overflow-y-auto modal z-999999">
    <div data-modal-target="createUserModal" data-modal-toggle="createUserModal"
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-9">
                ...
                <div class="col-span-1 sm:col-span-3">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" placeholder="Enter the email"
                        autofocus autocomplete="off"
                        class="h-11 w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs @error('email') bg-red-50 dark:bg-red-900/20 border-red-500 text-red-600 placeholder-red-50 focus:ring-red-500/10 focus:border-red-300 dark:text-red-500 dark:placeholder-red-500 dark:border-red-800 dark:focus:ring-red-50/10 dark:focus:border-red-800 @enderror border-gray-300 text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                    @error('email')
                    <p class="mt-2 text-xs text-red-600 dark:text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-1 sm:col-span-3">
                    ...
                    <input type="password" name="password" id="password" value="{{ old('password') }}"
                        placeholder="Enter the password" autofocus autocomplete="off"
                        class="h-11 w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs @error('password') bg-red-50 dark:bg-red-900/20 border-red-500 text-red-600 placeholder-red-50 focus:ring-red-500/10 focus:border-red-300 dark:text-red-500 dark:placeholder-red-500 dark:border-red-800 dark:focus:ring-red-50/10 dark:focus:border-red-800 @enderror border-gray-300 text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                    @error('password')
                    <p class="mt-2 text-xs text-red-600 dark:text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-1 sm:col-span-3">
                    <label for="lastname" class=" mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        Nama Belakang
                    </label>
                    <input type="text" name="lastname" id="lastname" value="{{ old('lastname') }}"
                        placeholder="Enter the lastname" autofocus autocomplete="off"
                        class="h-11 w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs @error('lastname') bg-red-50 dark:bg-red-900/20 border-red-500 text-red-600 placeholder-red-50 focus:ring-red-500/10 focus:border-red-300 dark:text-red-500 dark:placeholder-red-500 dark:border-red-800 dark:focus:ring-red-50/10 dark:focus:border-red-800 @enderror border-gray-300 text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                    @error('lastname')
                    <p class="mt-2 text-xs text-red-600 dark:text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-1 sm:col-span-3">
                    ...
                    <input type="text" name="city_of_birth" id="city_of_birth" value="{{ old('city_of_birth') }}"
                        placeholder="Enter the city" autofocus autocomplete="off"
                        class="h-11 w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs @error('city_of_birth') bg-red-50 dark:bg-red-900/20 border-red-500 text-red-600 placeholder-red-50 focus:ring-red-500/10 focus:border-red-300 dark:text-red-500 dark:placeholder-red-500 dark:border-red-800 dark:focus:ring-red-50/10 dark:focus:border-red-800 @enderror border-gray-300 text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                    @error('city_of_birth')
                    <p class="mt-2 text-xs text-red-600 dark:text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-1 sm:col-span-3">
                    ...
                    <input type="text" name="contact" id="contact" value="{{ old('contact') }}"
                        placeholder="Enter the date" autofocus autocomplete="off"
                        class="h-11 w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs @error('contact') bg-red-50 dark:bg-red-900/20 border-red-500 text-red-600 placeholder-red-50 focus:ring-red-500/10 focus:border-red-300 dark:text-red-500 dark:placeholder-red-500 dark:border-red-800 dark:focus:ring-red-50/10 dark:focus:border-red-800 @enderror border-gray-300 text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                    @error('contact')
                    <p class="mt-2 text-xs text-red-600 dark:text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-1 sm:col-span-9">
                    ...
                    <input
                        ...
                        aria-describedby="user_avatar_help" id="avatar-create" name="avatar" type="file"
                        accept="image/*">
