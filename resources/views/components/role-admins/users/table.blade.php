    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                ...
                <th scope="col" class="px-6 py-3 whitespace-nowrap w-16">Tempat, Tanggal Lahir</th>
                <th scope="col" class="px-6 py-3 whitespace-nowrap w-16">Jenis Kelamin</th>
            ...
            <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-6 py-3">
                    <div class="flex items-center font-medium whitespace-nowrap mr-3 max-w-xl">
                        <img src="{{ $user->avatar ? asset('storage/' . $user->avatar) : asset('assets/images/user/user-default.png') }}"
                            alt="{{ $user->firstname . ' ' . $user->lastname }}" class="h-8 w-8 mr-3 rounded-full">
                ...
                <div class="relative w-full max-w-[584px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
                    ...
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST"
                        ...
                        <h4 class="mb-6 text-lg font-medium text-gray-800 dark:text-white/90">
                            Mengubah Role dan Status Siswa
                        </h4>
            ...
            <div id="deleteUserModal-{{ $user->id }}"
                ...
                <div class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-sm leading-6 text-gray-500 dark:text-gray-400">
                            Apakah anda yakin ingin menghapus data siswa yang satu ini?
                        </p>
