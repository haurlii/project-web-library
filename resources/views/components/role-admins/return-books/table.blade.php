    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                ...
                <th scope="col" class="px-8 py-3 whitespace-nowrap mr-3 max-w-lg">Kode Pengembalian</th>
                ...
                <th scope="col" class="px-8 py-3 whitespace-nowrap mr-3 max-w-lg">Status Pengembalian</th>
        ...
        <tbody>
            ...
            <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-8 py-3 whitespace-nowrap max-w-lg">
                    ...
                    <span
                        ...
                        {{ $returnBook->fineBook?->payment_status ?? 'Belum dicek' }}
                    </span>
                    @else
                    <span
            ...
            <div id="checkReturnBookModal-{{ $returnBook->id }}"
                ...
                <div class="relative w-full max-w-[584px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
                    ...
                    <form action="{{ route('admin.return-book-checks.store') }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2">
                            ...
                            <div class="col-span-1 sm:col-span-2">
                                ...
                                <textarea placeholder="Tuliskan deskripsi dari kondisi buku..." type="text" rows="6"
                                    name="notes" id="notes" autocomplete="off"
