...
<div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
    ...
    <div
        ...
        <button data-modal-target="createReturnBookModal" data-modal-toggle="createReturnBookModal" type="button"
...
<!-- Create modal -->
<div id="createReturnBookModal" x-data="returnBook()"
    class="hidden fixed inset-0 items-center justify-center p-5 overflow-y-auto modal z-999999">
    <div data-modal-target="createReturnBookModal" data-modal-toggle="createReturnBookModal"
    ...
    <div class="relative w-full max-w-[960px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
        <!-- close btn -->
        <button data-modal-target="createReturnBookModal" data-modal-toggle="createReturnBookModal"
        ...
        <form action="{{ route('admin.return-books.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-6">
                ...
                <div class="col-span-1 sm:col-span-3">
                    ...
                    <input type="text" name="name" id="name" x-model="name" placeholder="Enter the user"
                    ...
                    <input type="hidden" name="user_id" id="user_id" x-model="user_id" placeholder="Enter the user"
                        autocomplete="off" />
                    @error('user_id')
                    <p class="mt-2 text-xs text-red-600 dark:text-red-500">{{ $message }}</p>
                    @enderror
                ...
                <div class="col-span-1 sm:col-span-3">
                    ...
                    <input type="text" name="title" id="title" x-model="title" placeholder="Enter the book title"
                        autocomplete="off" readonly
                        class="h-11 w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs @error('book_id') bg-red-50 dark:bg-red-900/20 border-red-500 text-red-600 placeholder-red-50 focus:ring-red-500/10 focus:border-red-300 dark:text-red-500 dark:placeholder-red-500 dark:border-red-800 dark:focus:ring-red-50/10 dark:focus:border-red-800 @enderror border-gray-300 text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                    <input type="hidden" name="book_id" id="book_id" x-model="book_id"
                ...
                <div class="col-span-1 sm:col-span-3">
                    ...
                    <div class="relative max-w-auto">
                        ...
                        <input id="return_date" datepicker datepicker-buttons datepicker-autoselect-today
                            datepicker-format="dd MM yyyy" type="text" name="return_date" readonly
                            value="{{ old('return_date') ?? \Carbon\Carbon::now()->format('d F Y') }}" readonly
                ...
                <div class="col-span-1 sm:col-span-6">
                    ...
                    <textarea placeholder="Tulis deskripsi dari kondisi buku..." type="text" rows="6" name="notes"
