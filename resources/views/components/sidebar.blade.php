    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="/">
            ...
            <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'"
                src="{{ asset('./assets/images/logo/logo-icon-1.svg') }}" alt="Logo" />
        </a>
    </div>
        ...
        <nav x-data="{selected: $persist('Dashboard')}">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <!-- Menu Item Author -->
                    <li>
                        <a href="/authors" @click="selected = (selected === 'Penulis Buku' ? '':'Penulis Buku')"
                    ...
                    <!-- Menu Item Publisher -->
                    <li>
                        <a href="/publishers" @click="selected = (selected === 'Penerbit Buku' ? '':'Penerbit Buku')"
                    ...
                    <!-- Menu Item Category -->
                    <li>
                        <a href="/categories" @click="selected = (selected === 'Kategori Buku' ? '':'Kategori Buku')"
                            class="menu-item group hover:menu-item-active hover:menu-item-icon-active"
                    ...
                    <!-- Menu Item Book -->
                    <li>
                        <a href="/books" @click="selected = (selected === 'Buku' ? '':'Buku')"
                            class="menu-item group hover:menu-item-active hover:menu-item-icon-active"
