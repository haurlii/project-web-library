    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                ...
                <th scope="col" class="px-8 py-3">Book Code</th>
                <th scope="col" class="px-8 py-3">Book Title</th>
                <th scope="col" class="px-8 py-3">ISBN</th>
                <th scope="col" class="px-8 py-3">Language</th>
                <th scope="col" class="px-8 py-3 whitespace-nowrap w-16">Publication Year</th>
                <th scope="col" class="px-8 py-3 whitespace-nowrap w-16">Number of Pages</th>
                <th scope="col" class="px-8 py-3">Author</th>
                <th scope="col" class="px-8 py-3">Publisher</th>
                <th scope="col" class="px-8 py-3">Category</th>
                <th scope="col" class="px-8 py-3">Price</th>
                <th scope="col" class="px-8 py-3">Stock</th>
                <th scope="col" class="px-8 py-3">Synopsis</th>
                ...
                <td class="px-8 py-3">
                    <div class="flex items-center font-medium whitespace-nowrap mr-3 max-w-2xl">
                        <img src="{{ $book->cover ? asset('storage/' . $book->cover) :
                                    asset('assets/images/user/user-default.png') }}" alt="{{ $book->title }}"
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-6">
                            ...
                            <div class="col-span-1 sm:col-span-6">
                                ...
                                <textarea placeholder="Enter a synopsis..." type="text" rows="6" name="synopsis"
                                    ...
                                    class="@error('synopsis') bg-red-50 dark:bg-red-900/20 border-red-500 text-red-600 placeholder-red-50 focus:ring-red-500/10 focus:border-red-300 dark:text-red-500 dark:placeholder-red-500 dark:border-red-800 dark:focus:ring-red-50/10 dark:focus:border-red-800 @enderror  dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">{{ old('synopsis') ?? $book->synopsis }}</textarea>
                                @error('synopsis')
                                <p class="mt-2 text-xs text-red-600 dark:text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-1 sm:col-span-1">
                                <div class="flex items-center justify-center m-3">
                                    <img src="{{ $book->cover ? asset('storage/' . $book->cover) :
                                    asset('assets/images/user/user-default.png') }}" alt="{{ $book->cover }}"
                                        class="h-[56px] w-auto rounded-full" id="avatar-preview-update">
                                </div>
                            </div>
                            ...
                            <div class="col-span-1 sm:col-span-5">
                                ...
                                <input
                                    ...
                                    id="avatar" name="cover" type="file" accept="image/*">
