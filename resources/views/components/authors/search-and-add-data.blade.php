...
<!-- Create modal -->
<div id="createAuthorModal" class="hidden fixed inset-0 items-center justify-center p-5 overflow-y-auto modal z-999999">
    <div data-modal-target="createAuthorModal" data-modal-toggle="createAuthorModal"
    ...
    <div class="relative w-full max-w-[584px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
        <!-- close btn -->
        <button data-modal-target="createAuthorModal" data-modal-toggle="createAuthorModal"
