    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                ...
                <th scope="col" class="px-4 py-3">Name Author</th>
        ...
        <tbody>
            ...
            <div id="updateAuthorModal-{{ $author->id }}"
                ...
                <div class="relative w-full max-w-[584px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
                    ...
                    <form action="/authors/{{ $author->slug }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-4">
                            ...
                            <div class="col-span-1 sm:col-span-3">
                                ...
                                <input
                                    ...
                                    aria-describedby="user_avatar_help" data-preview-target="avatar-preview-update"
