...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" href="{{ asset('logo-icon-1.svg') }}" type="image/svg+xml">
        <title>
            {{ $title }}
        </title>
                                ...
                                <form action="{{ route('login.store') }}" method="POST" class="space-y-5">
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="user_cred" name="user_cred"
                    ...
                    <div class="flex items-center justify-center z-1">
                        ...
                        <div class="flex flex-col items-center max-w-xs">
                            <a href="index.html" class="block mb-4">
                                <img src="{{ asset('assets/images/logo/uppercase-long-dark-1.svg') }}" alt="Logo" />
                            </a>
                            <p class="text-center text-gray-400 dark:text-white/60">
                                Be The First, Be Diffrent, Do The Best
                            </p>
                        </div>
                    </div>
                </div>
